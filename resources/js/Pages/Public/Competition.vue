...
<template>
  ...
  <div style="background: var(--ink); min-height: 100vh;">
    <PublicNav />
    <section class="comp-header-section" style="padding: 32px 0 0; border-bottom: 1px solid var(--line);">
      <div class="container">
    ...
    <section v-if="tab === 'standings'" style="padding: 32px 0;">
    ...
    <section v-else-if="tab === 'matches'" style="padding: 32px 0;">
      <div class="container">
    ...
    <section v-else-if="tab === 'knockout'" style="padding: 32px 0;">
      <div class="container">
    ...
    <section v-else-if="tab === 'live'" style="padding: 32px 0;">
      <div class="container">
