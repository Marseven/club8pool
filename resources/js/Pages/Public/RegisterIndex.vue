...
<template>
  ...
  <div style="background: var(--ink); min-height: 100vh;">
    ...
    <section v-if="open.length === 0" style="padding: 32px 0;">
      <div class="container">
    ...
    <section v-else style="padding: 32px 0;">
      <div class="container">
        <div class="comps-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 18px;">
    ...
    <section v-if="others.length" style="padding: 32px 0; border-top: 1px solid var(--line);">
      <div class="container">
        <h2 class="disp-a" style="font-size: clamp(24px, 6vw, 40px); margin-bottom: 18px;">Autres éditions</h2>
        <div class="comps-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px;">
