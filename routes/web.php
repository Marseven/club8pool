...
Route::get('/classement', [RankingController::class, 'index'])->name('ranking.index');
Route::get('/regles', [PagesController::class, 'rules'])->name('rules');
Route::get('/faq', [PagesController::class, 'faq'])->name('faq');
Route::get('/cgu', [PagesController::class, 'cgu'])->name('cgu');
Route::get('/confidentialite', [PagesController::class, 'privacy'])->name('privacy');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/scoring', [\App\Http\Controllers\Admin\LiveScoringController::class, 'index'])->name('scoring.index');
